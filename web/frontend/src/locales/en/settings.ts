...
'settings.system_info.config_files': 'Configuration Files',
  ...
  'settings.surface_color': 'Surface Color',
  'settings.appearance.density': 'Density',
  'settings.appearance.sub_theme': 'Theme & Background',
  'settings.appearance.sub_visibility': 'Visibility',
  'settings.appearance.sub_alerts': 'Dismissed Alerts',
  'settings.appearance.density_compact': 'Compact',
  'settings.appearance.density_default': 'Default',
  'settings.appearance.density_loose': 'Loose',
  ...
  'settings.charts.compare_tooltip_id': 'Show Run ID in Tooltip',
  'settings.charts.compare_tooltip_id_desc': 'Show run ID instead of alias in comparison chart tooltips',
  ...
  'settings.preset.label': 'Theme Preset',
  'settings.preset.custom': 'Custom',
  'settings.preset.default': 'Default (Auto)',
  'settings.preset.default_light': 'Default (Light)',
  'settings.preset.default_dark': 'Default (Dark)',
  'settings.preset.aurora_glass': 'Aurora Glass',
  'settings.preset.warm_sunset': 'Warm Sunset',
  'settings.preset.ocean_breeze': 'Ocean Breeze',
  'settings.preset.midnight_purple': 'Midnight Purple',
  'settings.preset.rose_dawn': 'Rose Dawn',
  'settings.preset.cyber_neon': 'Cyber Neon',
  'settings.preset.frosted_glass': 'Frosted Glass',
  'settings.preset.deep_space': 'Deep Space',
  'settings.preset.cherry_blossom': 'Cherry Blossom',
  'settings.preset.minimal': 'Minimal',
  'settings.preset.slate': 'Slate',
  'settings.preset.ink_wash': 'Ink Wash',
  'settings.preset.amoled_black': 'AMOLED Black',
  'settings.preset.arctic_blue': 'Arctic Blue',
  'settings.preset.lavender_haze': 'Lavender Haze',
  'settings.preset.ember_glow': 'Ember Glow',
  'settings.preset.forest_mist': 'Forest Mist',
  'settings.cards.theme': 'Theme',
  'settings.cards.background': 'Background',
  'settings.cards.visual_effects': 'Visual Effects',
  'settings.cards.visibility': 'Display & Visibility',
  'settings.cards.storage': 'Storage Settings',
  'settings.cards.import_export': 'Import & Export',
  'settings.cards.experiment_refresh': 'Experiment Refresh',
  'settings.cards.gpu_telemetry': 'GPU Telemetry',
  'settings.cards.notifications': 'Notifications',
  ...
  'settings.data.detected_roots.title': 'Detect Existing Runicorn Data Directories',
  'settings.data.detected_roots.hint': 'Choose a scan root and depth, then look for existing Runicorn storage roots.',
  'settings.data.detected_roots.scan_root_placeholder': 'e.g. D:\\Users\\you',
  'settings.data.detected_roots.depth': 'Depth',
  'settings.data.detected_roots.action': 'Start Detection',
  'settings.data.detected_roots.prompt': 'Use the controls above to search for existing Runicorn data directories.',
  'settings.data.detected_roots.empty': 'No existing Runicorn data directories were detected.',
  'settings.data.detected_roots.candidate_runs': '{{count}} runs',
  'settings.data.detected_roots.candidate_archive': 'archive',
  'settings.data.detected_roots.candidate_index': 'index',
  ...
  'settings.messages.detect_failed': 'Detection failed',
  ...
  'offline_import.supports': 'Supports .zip / .tar.gz (internal layout: runs/<path>/<run_id>)',
  'offline_import.previewing': 'Analyzing archive…',
  'offline_import.success': 'Imported {{count}} new runs.',
  'offline_import.success_with_skip': 'Imported {{count}} new runs, {{skipped}} duplicates skipped.',
  'offline_import.failed': 'Import failed',
  'offline_import.preview_title': 'Import Preview',
  'offline_import.file_label': 'File:',
  'offline_import.detected_runs': 'Detected {{count}} runs, {{files}} files total',
  'offline_import.conflict': 'exists',
  'offline_import.conflict_warning': '{{count}} runs already exist locally and will be skipped.',
  'offline_import.mode_label': 'Import Mode',
  'offline_import.mode_isolate': 'Isolated Import',
  'offline_import.mode_isolate_desc': 'Place under imports/<timestamp>/ path, no impact on existing experiments',
  'offline_import.mode_merge': 'Merge Import',
  'offline_import.mode_merge_desc': 'Merge directly into existing paths, existing files will be overwritten',
  'offline_import.confirm_import': 'Confirm Import',
  ...
  'settings.performance.gpu_poll_interval': 'Poll Interval',
  'settings.performance.gpu_max_duration': 'Max History',
